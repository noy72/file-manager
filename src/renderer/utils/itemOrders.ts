...
const compare = (a: ItemForRenderer, b: ItemForRenderer, key: keyof ItemForRenderer, desc: boolean, convertFunc: (a: unknown) => unknown): CompareNumber => {
...
const wrapper = (key: keyof ItemForRenderer, desc: boolean, convertFunc: (a: unknown) => unknown = (a) => a): (a: ItemForRenderer, b: ItemForRenderer) => CompareNumber => {
    return (a: ItemForRenderer, b: ItemForRenderer) => compare(a, b, key, desc, convertFunc);
}
...
export const itemOrders: { [index: string]: (a: ItemForRenderer, b: ItemForRenderer) => CompareNumber } = {
